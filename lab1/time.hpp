...
public:
	...
	int		get_beginHour();	// API function that returns beginning hour of appointment slot
	int		get_beginMinute();	// API function that returns beginning hour of appointment slot
	int		get_endHour();		// API function that returns beginning hour of appointment slot
	int		get_endMinute();	// API function that returns beginning hour of appointment slot
