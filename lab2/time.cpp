...
int TimeRange::get_beginHour() const { return beginHour; };		//API function that returns the value of the private variable beginHour
int	TimeRange::get_beginMinute() const { return beginMinute; };	//API function that returns the value of the private variable beginMinute
int	TimeRange::get_endHour() const { return endHour; };			//API function that returns the value of the private variable endHour
int	TimeRange::get_endMinute() const { return endMinute; };		//API function that returns the value of the private variable endMinute
